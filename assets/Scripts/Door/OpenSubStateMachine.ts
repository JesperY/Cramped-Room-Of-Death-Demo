...
export default class OpenSubStateMachine extends DirectionSubStateMachine{
  constructor(fsm:StateMachine){
    super(fsm)
    this.stateMachine.set(DIRECTION_ENUM.UP, new State(fsm, `${BASE_URL}`))
    this.stateMachine.set(DIRECTION_ENUM.DOWN, new State(fsm, `${BASE_URL}`))
